      ...
      ******************************************************************
       ...
       01  DB2-CUSTOMER.
           ...
           03 DB2-NATIONAL-ID-NBR      PIC X(20).
           03 DB2-NIN-TYPE             PIC X(2).
           03 DB2-STREET-ADDRESS       PIC X(30).
           03 DB2-CITY                 PIC X(20).
           03 DB2-STATE                PIC X(2).
           03 DB2-COUNTRY-CODE         PIC X(3).
           03 DB2-SALES-TERRITORY      PIC X(5).
           03 DB2-AUTO-PAY             PIC X(1).
           03 DB2-CHECK-ACCT-NBR       PIC X(12).
           03 DB2-BANK-ROUTE-CODE      PIC X(9).
           03 DB2-CREDIT-CARD-TYP      PIC X(8).
           03 DB2-CREDIT-CARD-NBR      PIC X(16).
           03 DB2-CREDIT-CARD-PIN      PIC X(4).
           03 DB2-CARD-VAL             PIC X(5).
       ...
       01  DB2-ENDOWMENT.
           ...
           03 DB2-E-AUTO-PAY            PIC X(1).
           03 DB2-E-CHECK-ACCT-NBR      PIC X(12).
           03 DB2-E-BANK-ROUTE-CODE     PIC X(9).
           03 DB2-E-CREDIT-CARD-TYP     PIC X(8).
           03 DB2-E-CREDIT-CARD-NBR     PIC X(16).
           03 DB2-E-CREDIT-CARD-PIN     PIC X(4).
           03 DB2-E-CARD-VAL            PIC X(5).
           03 DB2-E-PADDINGDATA         PIC X(32556).
       ...
       01  DB2-HOUSE.
           ...
           03 DB2-H-STREET-ADDRESS     PIC X(30).
           03 DB2-H-CITY               PIC X(20).
           03 DB2-H-STATE              PIC X(2).
           03 DB2-H-COUNTRY-CODE       PIC X(3).
           03 DB2-H-AUTO-PAY           PIC X(1).
           03 DB2-H-CHECK-ACCT-NBR     PIC X(12).
           03 DB2-H-BANK-ROUTE-CODE    PIC X(9).
           03 DB2-H-CREDIT-CARD-TYP    PIC X(8).
           03 DB2-H-CREDIT-CARD-NBR    PIC X(16).
           03 DB2-H-CREDIT-CARD-PIN    PIC X(4).
           03 DB2-H-CREDIT-CARD-VAL    PIC X(5).
       ...
       01  DB2-MOTOR.
           ...
           03 DB2-M-CAR-YEAR           PIC X(4).
           03 DB2-M-CAR-VIN            PIC X(20).
           03 DB2-M-AUTO-PAY           PIC X(1).
           03 DB2-M-CHECK-ACCT-NBR     PIC X(12).
           03 DB2-M-BANK-ROUTE-CODE    PIC X(9).
           03 DB2-M-CREDIT-CARD-TYP    PIC X(8).
           03 DB2-M-CREDIT-CARD-NBR    PIC X(16).
           03 DB2-M-CREDIT-CARD-PIN    PIC X(4).
           03 DB2-M-CARD-VAL           PIC X(5).
       ...
       01  DB2-COMMERCIAL.
           ...
           03 DB2-B-STREET-ADDRESS     PIC X(30).
           03 DB2-B-CITY               PIC X(20).
           03 DB2-B-STATE              PIC X(2).
           03 DB2-B-COUNTRY-CODE       PIC X(3).
           03 DB2-B-AUTO-PAY           PIC X(1).
           03 DB2-B-CHECK-ACCT-NBR     PIC X(12).
           03 DB2-B-BANK-ROUTE-CODE    PIC X(9).
           03 DB2-B-CREDIT-CARD-TYP    PIC X(8).
           03 DB2-B-CREDIT-CARD-NBR    PIC X(16).
           03 DB2-B-CREDIT-CARD-PIN    PIC X(4).
           03 DB2-B-CREDIT-CARD-VAL    PIC X(5).
