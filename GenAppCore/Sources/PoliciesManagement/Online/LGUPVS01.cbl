      ...
      *  --------   --------------------  --------------------------  *
      *  02/04/16   P BARON               ADDED PROCESSING SCENARIO   *
      *                                   CICS ABNORMAL               *
      *                                   TERMINATION ASRA (S0C7)     *
      *                                                               *
      *                                                               *
      *****************************************************************
      ...
      ************************************
      *SCENARIO PROCESSING ABEND ASRA    *
      ************************************
       01  WS-REG-NUM                PIC 9(7) COMP-3.
       01  WS-REG-NUM-R REDEFINES WS-REG-NUM
                                     PIC X(7).
       01  WS-REG-NUM-QUOT           PIC 9(7) COMP-3.
      ************************************
      ...
      *SCENARIO PROCESSING ABEND ASRA    *
      ************************************
           IF WF-M-REGNUMBER =  'REG9999'
               COMPUTE WS-REG-NUM =  WS-REG-NUM / WS-REG-NUM-QUOT.
      ******************************
