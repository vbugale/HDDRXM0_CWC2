      ...
      ******************************************************************
      ******************************************************************
      ***** FORCE FIXED LENGTH VS VARIABLE LENGTH FOR INITIAL USAGE ****
      *****                                                         ****
      *****                                                         ****
            Move ZEROES           TO WS-VARY-LEN
      ****                                                          ****
      ******************************************************************
      ******************************************************************
              ...
              EXEC SQL
                INSERT INTO ENDOWMENT
                   ...
                   VALUES ( :DB2-POLICYNUM-INT,
                            ...
                            :CA-E-AUTO-PAY,
                            :CA-E-CHECK-ACCT-NBR,
                            :CA-E-BANK-ROUTE-CODE,
                            :CA-E-CREDIT-CARD-TYP,
                            :CA-E-CREDIT-CARD-NBR,
                            :CA-E-CREDIT-CARD-PIN,
                            :CA-E-CREDIT-CARD-VAL,
                            :WS-VARY-FIELD )
              END-EXEC
           ELSE
              EXEC SQL
           ...
           EXEC SQL
             INSERT INTO HOUSE
                ...
                VALUES ( :DB2-POLICYNUM-INT,
                         ...
                         :CA-H-AUTO-PAY,
                         :CA-H-CHECK-ACCT-NBR,
                         :CA-H-BANK-ROUTE-CODE,
                         :CA-H-CREDIT-CARD-TYP,
                         :CA-H-CREDIT-CARD-NBR,
                         :CA-H-CREDIT-CARD-PIN,
                         :CA-H-CREDIT-CARD-VAL)
           END-EXEC
      ...
      *    Move numeric fields to integer format
           ...
           MOVE '2000-01-01'     TO CA-M-MANUFACTURED
           ...
           EXEC SQL
             INSERT INTO MOTOR
                ...
                VALUES ( :DB2-POLICYNUM-INT,
                         ...
                         :CA-M-AUTO-PAY,
                         :CA-M-CHECK-ACCT-NBR,
                         :CA-M-BANK-ROUTE-CODE,
                         :CA-M-CREDIT-CARD-TYP,
                         :CA-M-CREDIT-CARD-NBR,
                         :CA-M-CREDIT-CARD-PIN,
                         :CA-M-CREDIT-CARD-VAL)
           END-EXEC
           ...
           EXEC SQL
             INSERT INTO COMMERCIAL
                ...
                VALUES (
                         ...
                         :CA-B-AUTO-PAY,
                         :CA-B-CHECK-ACCT-NBR,
                         :CA-B-BANK-ROUTE-CODE,
                         :CA-B-CREDIT-CARD-TYP,
                         :CA-B-CREDIT-CARD-NBR,
                         :CA-B-CREDIT-CARD-PIN,
                         :CA-B-CREDIT-CARD-VAL)
