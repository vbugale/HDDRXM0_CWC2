               ...
               UPDATE ENDOWMENT
                 SET
                   WITHPROFITS         = :CA-E-WITH-PROFITS,
                     ...
                     AUTOPAY           = :CA-E-AUTO-PAY,
                     CHECKACCTNBR      = :CA-E-CHECK-ACCT-NBR,
                     BANKROUTECODE     = :CA-E-BANK-ROUTE-CODE,
                     CREDITCARDTYPE    = :CA-E-CREDIT-CARD-TYP,
                     CREDITCARDNBR     = :CA-E-CREDIT-CARD-NBR,
                     CREDITCARDPIN     = :CA-E-CREDIT-CARD-PIN,
                     CREDITVALIDTHRU   = :CA-E-CREDIT-CARD-VAL
           ...
           EXEC SQL
             UPDATE HOUSE
               SET
                    ...
                    STREETADDRESS    = :CA-H-STREET-ADDRESS,
                    CITY             = :CA-H-CITY,
                    STATE            = :CA-H-STATE,
                    COUNTRYCODE      = :CA-H-COUNTRY-CODE,
                    AUTOPAY          = :CA-H-AUTO-PAY,
                    CHECKACCTNBR     = :CA-H-CHECK-ACCT-NBR,
                    BANKROUTECODE    = :CA-H-BANK-ROUTE-CODE,
                    CREDITCARDTYPE   = :CA-H-CREDIT-CARD-TYP,
                    CREDITCARDNBR    = :CA-H-CREDIT-CARD-NBR,
                    CREDITCARDPIN    = :CA-H-CREDIT-CARD-PIN,
                    CREDITVALIDTHRU  = :CA-H-CREDIT-CARD-VAL
               WHERE
                    POLICYNUMBER = :DB2-POLICYNUM-INT
           END-EXEC
           ...
           EXEC SQL
             UPDATE MOTOR
               SET
                    ...
                    CARYEAR           = :CA-M-CAR-YEAR,
                    CARVIN            = :CA-M-CAR-VIN,
                    AUTOPAY           = :CA-M-AUTO-PAY,
                    CHECKACCTNBR      = :CA-M-CHECK-ACCT-NBR,
                    BANKROUTECODE     = :CA-M-BANK-ROUTE-CODE,
                    CREDITCARDTYPE    = :CA-M-CREDIT-CARD-TYP,
                    CREDITCARDNBR     = :CA-M-CREDIT-CARD-NBR,
                    CREDITCARDPIN     = :CA-M-CREDIT-CARD-PIN,
                    CREDITVALIDTHRU   = :CA-M-CREDIT-CARD-VAL
               WHERE
                    POLICYNUMBER      = :DB2-POLICYNUM-INT
           END-EXEC
